...
Underrepresented Students Added (Page 2)
=====================================
...
### Chart 2A - Distribution of Percentage of Underrepresented Students Added to AP/IB Overal Baseline, by Fiscal Year {data-width=5}
...
Percentage of Underrepresented Students Added by School (Page 3)
=====================================
...
```{r}
  ...
  renderPlot({
      ...
      ggplot(data = selected_data_p3(), aes(x = num_ap_students_added, y = perc_ap_ur_students_added)) +
        geom_point(size   = 5,
                   colour = "#3B9AB2") +
